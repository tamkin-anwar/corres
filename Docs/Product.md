...
4. Full and incremental sync, inbox and sent threads, reconciliation, retries, deletion, and stale-history recovery. First pass done (2026-09-21): 25 most recent inbox messages, real sender/subject/body, one-way (no writes back to Gmail), no history cursor yet. See ADR 005.
