...
1. Verify native foundation: real simulator and device QA, VoiceOver, large text, contrast, transitions, performance, and final icon assets.
2. Implement protected local persistence with migrations, recovery tests, account isolation, and explicit sign-out purge.
3. Add a Gmail adapter and system-browser OAuth. Test revoked access, expired tokens, account switching, and cancellation.
